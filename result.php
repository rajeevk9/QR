	...
	<body onload="startTime()" style="font-size: 1.5rem !important;">
		<div class="container" style="padding: 24px;">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label>Name</label>
						<input type="text" class="form-control" name="uname" style="width:25em;" value="<?php echo @$uname; ?>" required placeholder="Enter Your Name">
					</div>
					<div class="form-group">
						<label>Email</label>
						<input type="email" class="form-control" name="email" style="width:25em;" value="<?php echo @$email; ?>" required placeholder="Enter Your Email">
					</div>
				
					<div class="form-group">
						<label>Mobile</label>
						<input type="tel" class="form-control" name="mob" style="width:25em;" value="<?php echo @$mob; ?>" required placeholder="Enter Your Mobile Number">
					</div>
					</div>
				<div class="col-md-6">
					<div class="form-group">
						<label>Problem Type</label>
						<select class="form-control" name="prbtype" style="width:25em;" value="<?php echo @$prbtype; ?>"  required placeholder="Enter Product Expiry Date">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="prbdetails" style="width:25em;" value="<?php echo @$prbdetails; ?>" required placeholder="Enter Your Problems in Details"></textarea>
					</div>
					<div class="form-group">
